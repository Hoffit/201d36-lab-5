...
function sumArray(sumArr) { //eslint-disable-line
  ...
  //Another approach would have combined for loop with sum function
  //Internet suggests another approach; [1,2,3].reduce(function(acc, val) { return acc + val; });
  console.log(sumArr);
  var sumValue = sumArr[0];
  if(sumArr.length>1) {
    sumValue = sum(sumArr[0], (sumArray(sumArr.slice(1,sumArr.length)))[0])[0];
  }

  console.log(sumValue);

  return [sumValue, sumArr+' was passed in as an array of numbers, and '+sumValue+' is their sum.'];
}
